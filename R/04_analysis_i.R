...
drug_boxplot <- pbc_data_aug %>% 
  ...
  theme_classic() + 
  labs(title = "Distribution of age in the two drug treatments for both sex",
       x = "Age", y = "Drug",
...
pbc_data_aug %>% 
  ...
  geom_boxplot(alpha = 0.5) +
  theme_classic() +
  labs(title = "Distribution of age in the three Mayo risk score levels for both sex,",
       x = "Age", y = "Mayo risk score level",
       caption = "Data from https://hbiostat.org/data/") +
  theme(plot.caption = element_text(hjust = 1, face = "italic"),
        plot.title.position = "plot", plot.caption.position = "plot") +
...
pbc_data_aug %>% 
  ...
  theme_classic() +
  labs(title = "Distribution of participants in the three Mayo risk score levels",
       x = "Mayo risk score level", y = "Percentage",
       caption = "Data from https://hbiostat.org/data/") +
  theme(plot.caption = element_text(hjust = 1, face = "italic"),
...
pbc_data_aug %>% 
  ...
  theme_classic() +
  labs(title = "Distribution of sex in the data",
       x = "Sex", y = "Percentage",
       caption = "Data from https://hbiostat.org/data/") +
  theme(plot.caption = element_text(hjust = 1, face = "italic"),
        plot.title.position = "plot", plot.caption.position = "plot", legend.position = "none")
...
pbc_data_aug %>%
  ...
  geom_point() +  
  theme_classic() +
  labs(title = "Correlation between Serum Bilirubin and Time to Death or Liver Transplantation",
       x = "Time to Death or Liver Transplantation", y = "Serum Bilirubin (mg/dl)",
       caption = "Data from https://hbiostat.org/data/") +
  theme(plot.caption = element_text(hjust = 1, face = "italic"),
        plot.title.position = "plot", plot.caption.position = "plot") +
...
p1 <- pbc_data_aug %>% 
  ...
  geom_histogram(binwidth = 365.25, fill= "royalblue4", color = "royalblue4", alpha = 0.5) +
  theme_classic() +
...
p2 <- pbc_data_aug %>% 
  filter(status == 1) %>% 
  ggplot(mapping = aes(x = fu.days)) +
  geom_histogram(binwidth = 365.25, aes(fill= "red", color = "red"), alpha = 0.5) +
  theme_classic() +
...
p3 <- pbc_data_aug %>% 
  filter(status == 0) %>% 
  ggplot(mapping = aes(x = fu.days)) +
  geom_histogram(binwidth = 365.25, fill= "green4", color = "green4", alpha = 0.5) +
  theme_classic() +
  labs(title = "Participants with status 0",
       x = "Time to Death or Liver Transplantation", y = "Count",
       caption = "Data from https://hbiostat.org/data/") +
  theme(plot.caption = element_text(hjust = 1, face = "italic"),
        plot.title.position = "plot", plot.caption.position = "plot", legend.position = "none")
...
p1 <- pbc_data_aug %>% 
  ...
  geom_boxplot(alpha = 0.5, fill = "royalblue4", color = "royalblue4") +
  theme_classic() +
...
p2 <- pbc_data_aug %>%
  ...
  geom_boxplot(alpha = 0.5, fill = "red", color = "red") +
  theme_classic() +
...
p3 <- pbc_data_aug %>%
  ...
  mutate(stage = factor(stage, levels = c(1,2,3,4))) %>% 
  ggplot(mapping = aes(x = fu.days, y = stage)) +
  geom_boxplot(alpha = 0.5, fill = "green4", color = "green4") +
  theme_classic() +
  labs(title = "Participants in status 0 in stage 1-4",
       x = "Time to Death or Liver Transplantation", y = "Stage", 
       caption = "Data from https://hbiostat.org/data/") +
  theme(plot.caption = element_text(hjust = 1, face = "italic"),
        plot.title.position = "plot", plot.caption.position = "plot", legend.position = "none")
...
pbc_data_aug %>%
  ...
  geom_boxplot(alpha = 0.5) +
  theme_classic() +
  labs(title = "Time to Death or Liver Transplantation at stage 1 to 4 in relation to the two drugs",
       x = "Time to Death or Liver Transplantation", y = "Stage", 
       caption = "Data from https://hbiostat.org/data/") +
  theme(plot.caption = element_text(hjust = 1, face = "italic"),
        plot.title.position = "plot", plot.caption.position = "plot") +
...
pbc_data_aug %>%
  ...
  geom_boxplot(alpha = 0.5) +
  theme_classic() +
  labs(title = "Time to Death or Liver Transplantation at status 0 or 1 in relation to the two drugs",
       x = "Time to Death or Liver Transplantation", y = "Status", 
       caption = "Data from https://hbiostat.org/data/") +
  theme(plot.caption = element_text(hjust = 1, face = "italic"),
        plot.title.position = "plot", plot.caption.position = "plot") +
...
pbc_data_aug %>% 
  ...
  theme_classic() +
  labs(title = "Number of participants in status 0 or 1 in relation to the two drugs",
       x = "Status", y = "Count", 
       caption = "Data from https://hbiostat.org/data/") +
  theme(plot.caption = element_text(hjust = 1, face = "italic"),
        plot.title.position = "plot", plot.caption.position = "plot") +
...
pbc_data_aug %>% 
  ...
  geom_point() +
  theme_classic() +
  labs(title = "Correlation between Platelets and Prothrombin Time at stages 1 to 4",
       x = "Platelets (per cm^3/1000)", y = "Prothrombin Time (sec.)", 
       caption = "Data from https://hbiostat.org/data/") +
  theme(plot.caption = element_text(hjust = 1, face = "italic"),
        plot.title.position = "plot", plot.caption.position = "plot") +
...
pbc_data_aug %>% 
  ...
  geom_bar(position = "dodge")  +
  theme_classic() +
  labs(title = "Count of participants with and without spiders",
       x = "Spiders", y = "Count", 
       caption = "Data from https://hbiostat.org/data/") +
  theme(plot.caption = element_text(hjust = 1, face = "italic"),
        plot.title.position = "plot", plot.caption.position = "plot") +
...
pbc_data_aug %>% 
  ...
  theme_classic() +
  labs(title = "Time to Death or Liver Transplantation in relation to the drugs",
       x = "Time to Death or Liver Transplantation", y = "Cumulative count", 
       caption = "Data from https://hbiostat.org/data/") +
  theme(plot.caption = element_text(hjust = 1, face = "italic"),
        plot.title.position = "plot", plot.caption.position = "plot") +
...
pbc_data_aug %>%
  ...
  geom_step(aes(x=fu.days,y=(312-cumulative_count)/312)) +
  theme_classic() +
  labs(title = "Time to Death or Liver Transplantation in relation to the 4 stages",
       x = "Time to Death or Liver Transplantation", y = "Cumulative count", 
       caption = "Data from https://hbiostat.org/data/") +
  theme(plot.caption = element_text(hjust = 1, face = "italic"),
        plot.title.position = "plot", plot.caption.position = "plot") +
